...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.plan.search', {
    url: '/',
    views: {
      'planContent': {
        templateUrl: 'templates/plan.search.html',
...
.run(function($httpBackend) {
  ...
  var routes = ['templates/playlist.html', 'templates/playlists.html', 'templates/browse.html', 'templates/search.html', 'templates/menu.html', 'templates/login.html', 'templates/plan.html', 'templates/plan.search.html', 'templates/plan.read.html', 'templates/autofingerlist.html', 'templates/options.html', 'templates/editplan.html'];
  for(var i in routes) {

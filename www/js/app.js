angular.module('grinnellplans-mobile', ['ionic', 'grinnellplans-mobile.controllers'])
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  // Special footer content for My Plan with specific features (ie. editing).
  ...
  // General footer content for reading other plans with specific features
...
.run(function($httpBackend) {
  ...
  // For read.
  $httpBackend.whenGET('https://www.grinnellplans.com/api/1/?task=read')
  ...
  var routes = ['templates/playlist.html', 'templates/playlists.html', 'templates/browse.html', 'templates/search.html', 'templates/menu.html', 'templates/login.html', 'templates/plan.html', 'templates/plan.my.html', 'templates/plan.read.html', 'templates/autofingerlist.html', 'templates/options.html'];
  for(var i in routes) {
